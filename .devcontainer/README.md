...
1. Open the `shop/` folder **directly** in VS Code:
   ...
   - Verify the Explorer sidebar shows `MY_SHOP` at the top and contains `Run-AllSystemTests.ps1`, `CLAUDE.md`, and `.devcontainer/` at the root. If it shows any other folder name, you opened the wrong level.
