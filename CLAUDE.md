...
For full-suite runs across all three languages (latest + legacy), use `./run-all-system-tests.sh` from the repo root — see [docs/running-system-tests.md](docs/running-system-tests.md).
