...
.DESCRIPTION
    ...
    CI runs the same analysis from multitier-frontend-react-commit-stage.yml;
...
Write-Host "Running SonarScanner for multitier React frontend..." -ForegroundColor Cyan
