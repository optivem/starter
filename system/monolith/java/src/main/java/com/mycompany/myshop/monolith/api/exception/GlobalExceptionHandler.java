package com.mycompany.myshop.monolith.api.exception;
...
import com.mycompany.myshop.monolith.core.validation.TypeValidationMessageExtractor;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private static final Pattern CLASS_NAME_PATTERN = Pattern.compile(
            "(com\\.mycompany\\.myshop\\.monolith\\.core\\.dtos\\.[^\\[\\]\"\\s\\)]+)");
