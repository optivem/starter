package com.optivem.starter.monolith.api.exception;
...
import com.optivem.starter.monolith.core.validation.TypeValidationMessageExtractor;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private static final Pattern CLASS_NAME_PATTERN = Pattern.compile(
            "(com\\.optivem\\.starter\\.monolith\\.core\\.dtos\\.[^\\[\\]\"\\s\\)]+)");
