package com.optivem.shop.testkit.core.usecase.external.clock;

import com.optivem.shop.testkit.driver.port.external.clock.ClockDriver;
import com.optivem.shop.testkit.core.usecase.external.clock.usecases.GetTime;
import com.optivem.shop.testkit.core.usecase.external.clock.usecases.GoToClock;
import com.optivem.shop.testkit.core.usecase.external.clock.usecases.ReturnsTime;
