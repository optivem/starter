package com.optivem.shop.testkit.core.scenario.when;

import com.optivem.shop.testkit.core.usecase.UseCaseDsl;
import com.optivem.shop.testkit.core.scenario.when.steps.WhenBrowseCouponsImpl;
import com.optivem.shop.testkit.core.scenario.when.steps.WhenCancelOrderImpl;
import com.optivem.shop.testkit.core.scenario.when.steps.WhenPlaceOrderImpl;
import com.optivem.shop.testkit.core.scenario.when.steps.WhenPublishCouponImpl;
import com.optivem.shop.testkit.core.scenario.when.steps.WhenViewOrderImpl;
